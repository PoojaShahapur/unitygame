...
public class TriggerEnterEvent : MonoBehaviour {
    ...
    void OnTriggerEnter(Collider other)
    {
        if (other.gameObject.CompareTag("SnowBall"))
        {
            ...
            //计算缩放比率            
            float newBallRadius = MathToolManager.getRadiusByMass(MathToolManager.getMassByRadius(colSnow.gameObject.GetComponent<Transform>().localScale.x) + MathToolManager.getMassByRadius(fatherObj.GetComponent<Transform>().localScale.x));
