...
public static class DelegateFactory
{
	...
	public static void Register()
	{
		...
		dict.Add(typeof(System.Action<string,string,string>), System_Action_string_string_string);
		...
		dict.Add(typeof(SDK.Lib.MAction<SDK.Lib.IDispatchObject>), SDK_Lib_MAction_SDK_Lib_IDispatchObject);
	...
	class System_Action_string_string_string_Event : LuaDelegate
	{
		public System_Action_string_string_string_Event(LuaFunction func) : base(func) { }

		public void Call(string param0,string param1,string param2)
		{
			func.BeginPCall();
			func.Push(param0);
			func.Push(param1);
	...
	public static Delegate System_Action_string_string_string(LuaFunction func)
	{
		if (func == null)
		{
			System.Action<string,string,string> fn = delegate { };
			return fn;
		}

		System.Action<string,string,string> d = (new System_Action_string_string_string_Event(func)).Call;
		return d;
	}
	...
	class SDK_Lib_MAction_SDK_Lib_IDispatchObject_Event : LuaDelegate
	{
		public SDK_Lib_MAction_SDK_Lib_IDispatchObject_Event(LuaFunction func) : base(func) { }

		public void Call(SDK.Lib.IDispatchObject param0)
		{
			func.BeginPCall();
			func.PushObject(param0);
			func.PCall();
	...
	public static Delegate SDK_Lib_MAction_SDK_Lib_IDispatchObject(LuaFunction func)
	{
		if (func == null)
		{
			SDK.Lib.MAction<SDK.Lib.IDispatchObject> fn = delegate { };
			return fn;
		}

		SDK.Lib.MAction<SDK.Lib.IDispatchObject> d = (new SDK_Lib_MAction_SDK_Lib_IDispatchObject_Event(func)).Call;
		return d;
	}
