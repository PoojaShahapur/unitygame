...
public static class LuaBinder
{
	...
	public static void Bind(IntPtr L, string type = null)
	{
		...
		switch (type) {
			...
			case "SDK_Lib_AuxLoaderBaseWrap": SDK_Lib_AuxLoaderBaseWrap.Register(L); break;
			...
			case "SDK_Lib_LuaSystemWrap": SDK_Lib_LuaSystemWrap.Register(L); break;
			case "SDK_Lib_MFileSysWrap": SDK_Lib_MFileSysWrap.Register(L); break;
