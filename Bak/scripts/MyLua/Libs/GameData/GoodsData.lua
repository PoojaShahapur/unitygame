...
function M:init()
    ...
    for i=1, self.shapeCount do
        self.shapeitems[i] = 
        {
            m_goodsID = GlobalNS.CSSystem.Ctx.mInstance.mSnowBallCfg.shape[i-1].ID;
            m_goodsName = GlobalNS.CSSystem.Ctx.mInstance.mSnowBallCfg.shape[i-1].Name;
            m_needID = GlobalNS.CSSystem.Ctx.mInstance.mSnowBallCfg.shape[i-1].NeedID;
            m_needNum = GlobalNS.CSSystem.Ctx.mInstance.mSnowBallCfg.shape[i-1].NeedNum;
            m_hot = GlobalNS.CSSystem.Ctx.mInstance.mSnowBallCfg.shape[i-1].Hot;
            m_only = GlobalNS.CSSystem.Ctx.mInstance.mSnowBallCfg.shape[i-1].Only;
        };
    end
    ...
    for i=1, self.childCount do
        self.childitems[i] = 
        {
            m_goodsID = GlobalNS.CSSystem.Ctx.mInstance.mSnowBallCfg.child[i-1].ID;
            m_goodsName = GlobalNS.CSSystem.Ctx.mInstance.mSnowBallCfg.child[i-1].Name;
            m_needID = GlobalNS.CSSystem.Ctx.mInstance.mSnowBallCfg.child[i-1].NeedID;
            m_needNum = GlobalNS.CSSystem.Ctx.mInstance.mSnowBallCfg.child[i-1].NeedNum;
            m_hot = GlobalNS.CSSystem.Ctx.mInstance.mSnowBallCfg.child[i-1].Hot;
            m_only = GlobalNS.CSSystem.Ctx.mInstance.mSnowBallCfg.child[i-1].Only;
        };
    end
end
