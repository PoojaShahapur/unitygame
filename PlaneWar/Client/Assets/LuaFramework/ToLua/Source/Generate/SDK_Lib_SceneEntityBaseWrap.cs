...
public class SDK_Lib_SceneEntityBaseWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("setWillVisible", setWillVisible);
		L.RegFunction("isWillVisible", isWillVisible);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int setWillVisible(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 2);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int isWillVisible(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 1);
			SDK.Lib.SceneEntityBase obj = (SDK.Lib.SceneEntityBase)ToLua.CheckObject(L, 1, typeof(SDK.Lib.SceneEntityBase));
			bool o = obj.isWillVisible();
			LuaDLL.lua_pushboolean(L, o);
			return 1;
		}
		catch(Exception e)
