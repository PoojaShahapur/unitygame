...
namespace SDK.Lib
{
    ...
    public class DownloadFileMgr
    {
        ...
        private bool isDownLoadConfigXmlSucceed = false;//游戏配置
        ...
        private void downloadConfigXml()
        {
            ...
            else
            {
                ...
                this.isDownLoadConfigXmlSucceed = true;
            }
        }
        ...
        private void onConfigDownLoad(IDispatchObject dispObj)
        {
            ...
            if (res.isSuccessLoaded())
            {
                ...
                isDownLoadConfigXmlSucceed = true;
            }
            else
            {
                isDownLoadConfigXmlSucceed = false;
            }
        }

        public bool getIsDownloadSucceed()
        {
            return isDownLoadServerXmlSucceed && isDownLoadConfigXmlSucceed;
        }
