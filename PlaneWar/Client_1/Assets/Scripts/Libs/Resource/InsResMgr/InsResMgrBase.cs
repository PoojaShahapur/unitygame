...
namespace SDK.Lib
{
    ...
    public class InsResMgrBase
    {
        ...
        public T getAndSyncLoad<T>(string path, LuaTable luaTable, LuaFunction luaFunction, LuaInterface.LuaFunction progressLuaFunction = null, bool isLoadAll = false) where T : InsResBase, new()
        {
        ...
        public T getAndAsyncLoad<T>(string path, LuaTable luaTable, LuaFunction luaFunction, LuaInterface.LuaFunction progressLuaFunction = null, bool isLoadAll = false) where T : InsResBase, new()
        {
            T ret = null;
