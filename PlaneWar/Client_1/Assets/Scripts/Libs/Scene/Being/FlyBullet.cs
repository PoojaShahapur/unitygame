namespace SDK.Lib
{
    ...
    public class FlyBullet : BeingEntity
    {
        ...
        public FlyBulletFlock mFlyBulletFlock;

        public FlyBullet(FlyBulletFlock flock)
        {
        ...
        override public void dispose()
        {
            ...
            if (null != this.mFlyBulletFlock)
            {
                this.mFlyBulletFlock.mFlyBulletMgr.removeFlyBullet(this);
            }
        ...
        override public void autoHandle()
        {
            ...
            if (null != this.mFlyBulletFlock)
            {
                this.mFlyBulletFlock.mFlyBulletMgr.addFlyBullet(this);
            }
        }
