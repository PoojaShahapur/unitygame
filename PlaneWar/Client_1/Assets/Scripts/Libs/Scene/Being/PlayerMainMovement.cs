namespace SDK.Lib
{
    public class PlayerMainMovement : PlayerMovement
    {
        ...
        protected void OnMove()
        {
            ...
            this.mRotate = UnityEngine.Quaternion.Euler(new UnityEngine.Vector3(0, 0, roate * UtilMath.fRad2Deg));
            this.updateOrient();
            this.moveForward();
        }
        ...
        override public void stopMove()
        {
            ...
            Ctx.mInstance.mGlobalDelegate.mMainPosStopChangedDispatch.dispatchEvent(this);
        }
