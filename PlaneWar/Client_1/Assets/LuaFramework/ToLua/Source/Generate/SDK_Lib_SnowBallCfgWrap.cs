...
public class SDK_Lib_SnowBallCfgWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegVar("planes", get_planes, set_planes);
		L.RegVar("snowblocks", get_snowblocks, set_snowblocks);
	...
	static int get_planes(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			SDK.Lib.SnowBallCfg obj = (SDK.Lib.SnowBallCfg)o;
			SDK.Lib.XmlPlaneItem[] ret = obj.planes;
			ToLua.Push(L, ret);
			return 1;
		}
		catch(Exception e)
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index planes on a nil value" : e.Message);
		}
	}

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_snowblocks(IntPtr L)
	{
		object o = null;
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			SDK.Lib.SnowBallCfg obj = (SDK.Lib.SnowBallCfg)o;
			SDK.Lib.XmlPlaneItem[] ret = obj.snowblocks;
			ToLua.Push(L, ret);
			return 1;
		}
		catch(Exception e)
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index snowblocks on a nil value" : e.Message);
		}
	}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int set_planes(IntPtr L)
	{
		object o = null;
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			SDK.Lib.SnowBallCfg obj = (SDK.Lib.SnowBallCfg)o;
			SDK.Lib.XmlPlaneItem[] arg0 = ToLua.CheckObjectArray<SDK.Lib.XmlPlaneItem>(L, 2);
			obj.planes = arg0;
			return 0;
		}
		catch(Exception e)
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int set_snowblocks(IntPtr L)
	{
		object o = null;
