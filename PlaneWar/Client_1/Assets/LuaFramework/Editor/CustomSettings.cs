...
public static class CustomSettings
{
    ...
    {                
        ...
        _GT(typeof(SDK.Lib.AuxSpriteAtlasLoader)),
        _GT(typeof(SDK.Lib.AuxTextureLoader)),
        _GT(typeof(SDK.Lib.AuxTextLoader)),
        _GT(typeof(SDK.Lib.AuxLevelLoader)),
        _GT(typeof(SDK.Lib.AuxDownloader)),
        ...
        _GT(typeof(Game.Login.LoginNetHandleCB)),
