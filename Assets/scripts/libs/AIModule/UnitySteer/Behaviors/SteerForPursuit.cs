...
namespace UnitySteer.Behaviors
{
    ...
    public class SteerForPursuit : Steering
    {
        ...
        protected override Vector3 CalculateForce()
        {
            ...
            var parallelness = Vector3.Dot(Vehicle.sceneGo.transform.forward, _quarry.sceneGo.transform.forward);

            // how "forward" is the direction to the quarry
            // (1 means dead ahead, 0 is directly to the side, -1 is straight back)
            var forwardness = Vector3.Dot(Vehicle.sceneGo.transform.forward, unitOffset);
