...
CGPROGRAM
// Upgrade NOTE: excluded shader from DX11 and Xbox360; has structs without semantics (struct v2f members projTexCoord,bumpTexCoord,viewDir,lightDir,objSpaceNormal,foamStrengthAndDistance)
