...
public class SDK_Lib_CtxWrap
{
	public static void Register(IntPtr L)
	{
		...
		LuaField[] fields = new LuaField[]
		{
			...
			new LuaField("m_globalEventMgr", get_m_globalEventMgr, set_m_globalEventMgr),
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_m_globalEventMgr(IntPtr L)
	{
		object o = LuaScriptMgr.GetLuaObject(L, 1);
		SDK.Lib.Ctx obj = (SDK.Lib.Ctx)o;
		...
		if (obj == null)
		{
			...
			if (types == LuaTypes.LUA_TTABLE)
			{
				LuaDLL.luaL_error(L, "unknown member name m_globalEventMgr");
			}
			else
			{
				LuaDLL.luaL_error(L, "attempt to index m_globalEventMgr on a nil value");
			}
		}

		LuaScriptMgr.PushObject(L, obj.m_globalEventMgr);
		return 1;
	}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int set_m_globalEventMgr(IntPtr L)
	{
		object o = LuaScriptMgr.GetLuaObject(L, 1);
		SDK.Lib.Ctx obj = (SDK.Lib.Ctx)o;
		...
		obj.m_globalEventMgr = (SDK.Lib.GlobalEventMgr)LuaScriptMgr.GetNetObject(L, 3, typeof(SDK.Lib.GlobalEventMgr));
		return 0;
	}
