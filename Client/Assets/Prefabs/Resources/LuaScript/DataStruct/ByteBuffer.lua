...
ByteBuffer.m_position = 0   -- 缓冲区当前位置

local this = ByteBuffer   -- 局部引用

-- 读取一个字节
function ByteBuffer.readInt8(retData)
...
-- 读取两个字节
function ByteBuffer.readInt16(retData)
...
function ByteBuffer.readInt32(retData)
...
function ByteBuffer.readNumber(retData)
