...
namespace Game.Login
{
    ...
    public class LoginFlowHandle
    {
        ...
        public void connectLoginServer(string name, string passwd)
        {
            ...
            Ctx.m_instance.m_logSys.log(Ctx.m_instance.m_langMgr.getText(LangTypeId.eLTLog0, LangItemID.eItem0));
            // 连接 web 服务器
        ...
        {
            Ctx.m_instance.m_logSys.log(Ctx.m_instance.m_langMgr.getText(LangTypeId.eLTLog0, LangItemID.eItem2));
        ...
        {
            Ctx.m_instance.m_logSys.log(Ctx.m_instance.m_langMgr.getText(LangTypeId.eLTLog0, LangItemID.eItem8));
        ...
        public void psstServerReturnLoginFailedCmd(ByteBuffer msg)
        {
            ...
            {
                Ctx.m_instance.m_logSys.log(Ctx.m_instance.m_langMgr.getText(LangTypeId.eLTLog0, LangItemID.eItem13));
                // 重新登陆
            ...
            {
                Ctx.m_instance.m_logSys.log(Ctx.m_instance.m_langMgr.getText(LangTypeId.eLTLog0, LangItemID.eItem18));
                // 重新登陆
                Ctx.m_instance.m_loginSys.set_LoginState(LoginState.eLoginInfoError);
            }
        }
