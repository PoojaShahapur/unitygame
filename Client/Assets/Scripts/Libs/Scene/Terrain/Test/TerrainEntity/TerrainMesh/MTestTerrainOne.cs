namespace SDK.Lib
{
     ...
     */
    public class MTestTerrainOne : MTestTerrain
    {
        protected TestHeightMapData m_heightMapData;    // 高度图数据
        protected TestHeightMapMeshOne m_heightMapMesh;    // 高度图 Mesh
        protected MatRes m_matRes;                  // 材质资源

        public MTestTerrainOne()
        {
        ...
        override public void buildPage()
        {
            ...
            m_heightMapMesh = new TestHeightMapMeshOne(m_heightMapData, 5000, 1300, 5000, 250, 250);
