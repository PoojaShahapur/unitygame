namespace SDK.Lib
{
     ...
     * @brief Mesh 分割
     */
    public class TestMeshSplit
    {
        /**
         * @brief 生成顶点数据，注意这个顶点数据在局部空间已经移动到具体的位置了
         * @param inLocal 是否是在局部空间中生成数据
         */
        static public void buildVertex(int idx, int idz, TestHeightMapData heightMap, TestTerrainPageCfg terrainPageCfg, ref MList<float> vertices, bool bInLocal = false)
        {
         ...
         * @brief 生成索引数据
         */
        static public void buildIndex(int idx, int idz, TestHeightMapData heightMap, TestTerrainPageCfg terrainPageCfg, ref MList<int> indices)
        {
            int segmentsW = terrainPageCfg.getXGridCountPerTile();
            int segmentsH = terrainPageCfg.getZGridCountPerTile();
         ...
         * @brief 同时生成顶点和索引数据
         */
        static public void buildVertexAndIndex(int idx, int idz, TestHeightMapData heightMap, TestTerrainPageCfg terrainPageCfg, ref MList<float> vertices, ref MList<int> indices, bool bInLocal = false)
        {
            int segmentsW = terrainPageCfg.getXGridCountPerTile();
            int segmentsH = terrainPageCfg.getZGridCountPerTile();
         ...
         */
        static public bool buildUVs(int idx, int idz, TestHeightMapData heightMap, TestTerrainPageCfg terrainPageCfg, ref MList<float> uvs)
        {
