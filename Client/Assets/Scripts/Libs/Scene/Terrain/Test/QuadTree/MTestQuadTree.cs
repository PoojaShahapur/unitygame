namespace SDK.Lib
{
     ...
     * @brief 四叉树
     */
    public class MTestQuadTree : MTestPartition3D
    {
        ...
        public MTestQuadTree(MTestTerrain terrain)
            : base(null)
        {
            m_terrain = terrain;
            m_maxDepth = 0;
        ...
        protected void buildTree()
        {
            ...
            m_rootNode = new MTestQuadTreeNode(m_terrain, m_maxDepth, m_size, m_height, m_size / 2, m_size / 2);
            m_rootNode.postInit();
        }
