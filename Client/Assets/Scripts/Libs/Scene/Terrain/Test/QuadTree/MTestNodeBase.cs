...
namespace SDK.Lib
{
     ...
     * @brief 场景结点 Base
     */
    public class MTestNodeBase
    {
        protected MTestNodeBase m_parent;               // Parent 结点
		protected MList<MTestNodeBase> m_childNodes;    // Child 结点列表
		 ...
		 * @brief 构造函数
		 */
		public MTestNodeBase()
        {
            m_childNodes = new MList<MTestNodeBase>();
        }
		 ...
		 */
        public MTestNodeBase getParent()
		{
			return m_parent;
		}

        public void setParent(MTestNodeBase parent)
        {
            m_parent = parent;
        }
		 ...
		 * @brief 添加一个节点
		 */
        public void addNode(MTestNodeBase node)
		{
			node.setParent(this);
         ...
         * @brief 移除一个 Node
         */
        public void removeNode(MTestNodeBase node)
		{
		 ...
		 */
		virtual public MTestNodeBase findPartitionForEntity()
		{
			return this;
        }
