...
namespace SDK.Lib
{
     ...
     */
    public class MTestSubGeometryBase : MITestSubGeometry
    {
        protected MTestGeometry m_parentGeometry;
        ...
        public MTestGeometry getParentGeometry()
        {
            return m_parentGeometry;
        }

        public void setParentGeometry(MTestGeometry parentGeom)
        {
        ...
        protected void invalidateBounds()
        {
            ...
            {
                m_parentGeometry.invalidateBounds(this as MITestSubGeometry);
            }
        }
