namespace SDK.Lib
{
     ...
     * @brief 场景中可显示的对象
     */
    public class MTestSubMesh
    {
        protected MTestMesh m_parentMesh;            // Parent Mesh 
		protected MTestSubGeometryBase m_subGeometry;   // 显示的子 Geometry
        protected TestMeshRender m_meshRender;      // SubMesh 渲染器，和 Mesh 渲染器是一样的
        ...
        public MTestSubMesh(MTestSubGeometryBase subGeometry_ = null, TestMeshRender meshRender_ = null)
        {
            m_xPos = 0;
            m_zPos = 0;
            m_xTile = 0;
         ...
         * @brief 修改渲染器
         */
        public void setMeshRender(TestMeshRender meshRender_)
        {
            m_meshRender = meshRender_;
        }
