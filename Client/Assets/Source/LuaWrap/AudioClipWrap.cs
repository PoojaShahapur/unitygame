...
public class AudioClipWrap
{
	...
	static int Create(IntPtr L)
	{
		...
		else if (count == 6)
		{
			...
			int arg3 = (int)LuaScriptMgr.GetNumber(L, 4);
			bool arg4 = LuaScriptMgr.GetBoolean(L, 5);
			AudioClip.PCMReaderCallback arg5 = (AudioClip.PCMReaderCallback)LuaScriptMgr.GetNetObject(L, 6, typeof(AudioClip.PCMReaderCallback));
		...
		else if (count == 7)
		{
			...
			bool arg4 = LuaScriptMgr.GetBoolean(L, 5);
			AudioClip.PCMReaderCallback arg5 = (AudioClip.PCMReaderCallback)LuaScriptMgr.GetNetObject(L, 6, typeof(AudioClip.PCMReaderCallback));
			AudioClip.PCMSetPositionCallback arg6 = (AudioClip.PCMSetPositionCallback)LuaScriptMgr.GetNetObject(L, 7, typeof(AudioClip.PCMSetPositionCallback));
