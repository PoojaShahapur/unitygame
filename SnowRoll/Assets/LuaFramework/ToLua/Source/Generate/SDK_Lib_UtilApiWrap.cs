...
public class SDK_Lib_UtilApiWrap
{
	...
	static int addEventHandle(IntPtr L)
	{
		try
		{
			...
			else if (count == 2 && TypeChecker.CheckTypes(L, 1, typeof(UnityEngine.UI.Button), typeof(SDK.Lib.MAction<SDK.Lib.IDispatchObject>)))
			{
			...
			else if (count == 4 && TypeChecker.CheckTypes(L, 1, typeof(UnityEngine.GameObject), typeof(LuaInterface.LuaTable), typeof(LuaInterface.LuaFunction), typeof(bool)))
			{
				UnityEngine.GameObject arg0 = (UnityEngine.GameObject)ToLua.ToObject(L, 1);
				LuaTable arg1 = ToLua.ToLuaTable(L, 2);
				LuaFunction arg2 = ToLua.ToLuaFunction(L, 3);
	...
	static int addButtonDownEventHandle(IntPtr L)
	{
		try
		{
			...
			SDK.Lib.UtilApi.addButtonDownEventHandle(arg0, arg1, arg2);
			return 0;
		}
		catch(Exception e)
		{
	...
	static int addButtonUpEventHandle(IntPtr L)
	{
		try
		{
			...
			LuaTable arg1 = ToLua.CheckLuaTable(L, 2);
			LuaFunction arg2 = ToLua.CheckLuaFunction(L, 3);
			SDK.Lib.UtilApi.addButtonUpEventHandle(arg0, arg1, arg2);
			return 0;
		}
		catch(Exception e)
		{
	...
	static int addButtonExitEventHandle(IntPtr L)
	{
		try
		{
			...
			LuaTable arg1 = ToLua.CheckLuaTable(L, 2);
			LuaFunction arg2 = ToLua.CheckLuaFunction(L, 3);
			SDK.Lib.UtilApi.addButtonExitEventHandle(arg0, arg1, arg2);
			return 0;
		}
		catch(Exception e)
		{
