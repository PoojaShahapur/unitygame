...
public class SDK_Lib_AuxLoaderBaseWrap
{
	...
	static int syncLoad(IntPtr L)
	{
		try
		{
			...
			if (count == 3 && TypeChecker.CheckTypes(L, 1, typeof(SDK.Lib.AuxLoaderBase), typeof(string), typeof(SDK.Lib.MAction<SDK.Lib.IDispatchObject>)))
			{
			...
			else if (count == 4 && TypeChecker.CheckTypes(L, 1, typeof(SDK.Lib.AuxLoaderBase), typeof(string), typeof(LuaInterface.LuaTable), typeof(LuaInterface.LuaFunction)))
			{
				SDK.Lib.AuxLoaderBase obj = (SDK.Lib.AuxLoaderBase)ToLua.ToObject(L, 1);
				string arg0 = ToLua.ToString(L, 2);
