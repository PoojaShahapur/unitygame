...
public static class DelegateFactory
{
	...
	class System_Action_string_string_string_Event : LuaDelegate
	{
		...
		public System_Action_string_string_string_Event(LuaFunction func, LuaTable self) : base(func, self) { }
		...
		public void CallWithSelf(string param0, string param1, string param2)
		{
			func.BeginPCall();
			func.Push(self);
			func.Push(param0);
	...
	public static Delegate System_Action_string_string_string(LuaFunction func, LuaTable self, bool flag)
	{
		if (func == null)
		{
			System.Action<string,string,string> fn = delegate(string param0, string param1, string param2) { };
			return fn;
		}

		if(!flag)
		{
			System_Action_string_string_string_Event target = new System_Action_string_string_string_Event(func);
			System.Action<string,string,string> d = target.Call;
			target.method = d.Method;
			return d;
		}
		else
		{
			System_Action_string_string_string_Event target = new System_Action_string_string_string_Event(func, self);
			System.Action<string,string,string> d = target.CallWithSelf;
			target.method = d.Method;
			return d;
		}
	}
	...
	class SDK_Lib_MAction_SDK_Lib_IDispatchObject_Event : LuaDelegate
	{
		...
		public SDK_Lib_MAction_SDK_Lib_IDispatchObject_Event(LuaFunction func, LuaTable self) : base(func, self) { }
		...
		public void CallWithSelf(SDK.Lib.IDispatchObject param0)
		{
			func.BeginPCall();
			func.Push(self);
			func.PushObject(param0);
	...
	public static Delegate SDK_Lib_MAction_SDK_Lib_IDispatchObject(LuaFunction func, LuaTable self, bool flag)
	{
		if (func == null)
		{
			SDK.Lib.MAction<SDK.Lib.IDispatchObject> fn = delegate(SDK.Lib.IDispatchObject param0) { };
			return fn;
		}

		if(!flag)
		{
			SDK_Lib_MAction_SDK_Lib_IDispatchObject_Event target = new SDK_Lib_MAction_SDK_Lib_IDispatchObject_Event(func);
			SDK.Lib.MAction<SDK.Lib.IDispatchObject> d = target.Call;
			target.method = d.Method;
			return d;
		}
		else
		{
			SDK_Lib_MAction_SDK_Lib_IDispatchObject_Event target = new SDK_Lib_MAction_SDK_Lib_IDispatchObject_Event(func, self);
			SDK.Lib.MAction<SDK.Lib.IDispatchObject> d = target.CallWithSelf;
			target.method = d.Method;
			return d;
		}
	}
	...
	public static Delegate UnityEngine_Events_UnityAction_UnityEngine_GameObject(LuaFunction func, LuaTable self, bool flag)
	{
		if (func == null)
		{
