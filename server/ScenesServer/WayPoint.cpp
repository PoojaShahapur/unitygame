...
{
	return point[zMisc::randBetween(0,pointC-1)].GetRandPos();
}
...
* \return 目的点
*/
const zPoint WayPoint::getRandDest()
{
	zPoint m_Point;
	zPoint zPt = dest[zMisc::randBetween(0,destC-1)];
	m_Point.pos.pos = zPt.pos.GetRandPos();
