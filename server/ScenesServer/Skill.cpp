...
bool zSkill::IsMagicSkill()	//sky 检测技能是否是魔法系技能
{
...
bool zSkill::IsPhysicsSkill()	//sky 检测技能是否是物理系技能
{
...
bool zSkill::IsImmuneSkill()	//sky 检测技能是否能被免疫
{
...
bool zSkill::IsReboundSkill()	//sky 检测技能是否能被反射
{
...
bool zSkill::IsTreatmentSkill()	//sky 检测技能是否是治疗系
{
...
bool zSkill::IsBuffSkill()		//sky 检测技能是否是增益BUFF系
{
...
bool zSkill::IsDeBuffSkill()	//sky 检测技能是否是减益BUFF系
{
...
bool zSkill::IsDrugSkill()		//sky 检测技能是否是毒系
{
...
bool zSkill::IsOtherSkill()		//sky 检测技能是否是其他系
{
