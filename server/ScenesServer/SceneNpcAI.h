#ifndef _SceneNpcAI_h_
#define _SceneNpcAI_h_
...
struct t_NpcAIDefine
{
   ...
   */
  t_NpcAIDefine()
    :type(NPC_AI_NORMAL),pos(zPos(0,0)),regionX(2),regionY(2),chaseOut(10),lasttime(0),flee(false),fleeDir(-1),fleeCount(0)
    {
    }
...
typedef std::vector<t_NpcAIDefine> NpcAIDefineVec;
