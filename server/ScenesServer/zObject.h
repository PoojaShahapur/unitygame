...
struct zObject:zEntry
{
  ...
  public:
    ...
    bool getSaveData(SaveObject *save) const ;
    int foundSocket();
    bool canMail();
    void checkBind();
  ...
  public:
    bool fullMobileObject(t_Object_mobile &data);
};
...
class Package:private zNoncopyable
{
  ...
  public:
    virtual bool sort(SceneUser* pUser, DWORD flag=0);
    virtual DWORD typeWeight(WORD type);
    virtual bool needSwap(zObject* ob1, zObject* ob2);
