...
bool BillService::init()
{
  ...
  // */
  //
  if (!::Bill_init(Zebra::global["configdir"] + "billServerList.xml",Zebra::global["tradelogfilename"].c_str(),&bc) )
  {
...
if ("true" == Zebra::global["daemon"])
      {
	        ...
	        Zebra::logger->info("BillServer Program will be run as a daemon");
